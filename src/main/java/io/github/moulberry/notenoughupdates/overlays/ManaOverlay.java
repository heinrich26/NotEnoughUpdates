...
//	private static final ResourceLocation MANA_BAR = new ResourceLocation("notenoughupdates:manaHud");
//
//	@SubscribeEvent
//	public void onDrawScreenPost(RenderGameOverlayEvent.Post event) {
//		renderManaInvBar(event.resolution, totalMana, totalMaxMana);
//	}
//
//	private void renderManaInvBar(ScaledResolution res, int totalMana, int totalMaxMana) {
...
//		GuiUtils.drawTexturedModalRect(x, y, 0, 0, width, 5, 1f);
...
//		if (e.type == 2) {
//			parseActionBar(e.message.getUnformattedText());
//		}
//	}
//
...
//		String stripColoring = StringUtils.cleanColour(section);
//		String convertMag;
//
//		try {
//			convertMag = convertMagnitudes(stripColoring);
//
...
//			}
//			String numbersOnly = getNumbersOnly(convertMag).trim(); // keeps numbers and slashes
...
//	}
//
//	private static final String[] CRIMSON_ARMOR_SYMBOLS = new String[]{"ᝐ","⁑","Ѫ","҉"};
...
//			}
//
//			for (String stackSymbol : CRIMSON_ARMOR_SYMBOLS) {
//
...
//		float newHealth;
//		float maxHealth;
//		String stripped = StringUtils.cleanColour(healthSection);
...
//		// 421/421✎ 10ʬ
//		// 421/421✎ -10ʬ
//		Matcher m = MANA_PATTERN_S.matcher(StringUtils.cleanColour(manaSection).trim());
//		if (m.matches()) {
...
//		String stripped = StringUtils.cleanColour(defenseSection);
...
//			Matcher matcher = SKILL_GAIN_PATTERN_S.matcher(StringUtils.cleanColour(skillSection));
...
//		try {
//			return StringUtils.NUMBER_FORMAT.parse(string).floatValue();
//		} catch (ParseException e) {
//			return -1;
//		}
//	}
...
//
//		while (matcher.find()) {
//			double parsedDouble = StringUtils.NUMBER_FORMAT.parse(matcher.group(1)).doubleValue();
...
//			}
//
//			matcher.appendReplacement(sb, StringUtils.NUMBER_FORMAT.format(parsedDouble));
//		}
